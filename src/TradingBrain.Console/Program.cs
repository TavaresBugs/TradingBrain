...
static IReadOnlyList<StrategyKind> GridSearchStrategies(StrategyKind? requestedStrategy)
{
    return requestedStrategy is null
        ? new[] { StrategyKind.Momentum, StrategyKind.GoldBreakout, StrategyKind.Ema, StrategyKind.Range, StrategyKind.VwapReversion, StrategyKind.BollingerFade, StrategyKind.SessionBreakout }
